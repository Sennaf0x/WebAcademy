...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var categoria, subcategoria, ProdutoCriado, encontrarProduto, atualizarProduto, deletarProduto;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ProdutoCriado = _a.sent();
                    console.log('Produto criado:', ProdutoCriado);
                    return [4 /*yield*/, prisma.produto.findUnique({
                            where: {
                                id: ProdutoCriado.id,
                            },
